...
g++ build/Functions.o build/GameController.o build/Grapher.o build/Frame.o build/Button.o build/FrameBoard.o build/main.o -o build/main.exe -Iinclude -lsfml-graphics -lsfml-window -lsfml-system
